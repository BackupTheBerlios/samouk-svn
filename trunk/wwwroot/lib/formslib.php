<?php // $Id: formslib.php,v 1.129.2.8 2007/12/04 10:27:15 nicolasconnault Exp $
/**
 ...
 *
 * @author  Jamie Pratt
 * @version $Id: formslib.php,v 1.129.2.8 2007/12/04 10:27:15 nicolasconnault Exp $
...
class MoodleQuickForm extends HTML_QuickForm_DHTMLRulesTableless {
    ...
    function MoodleQuickForm($formName, $method, $action, $target='', $attributes=null){
        ...
        // 2007-09-04 kowy - let user of this class thinks up form name 
    ...
    */
    ...
    function setDefault($elementName, $defaultValue, $slashed=false){
    	// 2007-09-22 kowy - add if
    	$actualValue = (isset($this->_elementIndex[$elementName]) ? $this->exportValue($elementName) : null);
    	if ($actualValue==null || $actualValue=='') {
    		// if this is the first attempt to set default value (no submit value from previus step of a wizard are setted)
	        $filter = $slashed ? 'stripslashes' : NULL;
