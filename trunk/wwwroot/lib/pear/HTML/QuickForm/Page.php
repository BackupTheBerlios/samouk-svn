 ...
 */
//require_once $CFG->libdir.'/pear/HTML/QuickForm.php';
 ...
 */
class HTML_QuickForm_Page extends MoodleQuickForm // HTML_QuickForm
{
   /**
    ...
    */
    ...
    {
        // 2007-09-04 kowy - change parrent class to MoodleQuickForm
    	//$this->HTML_QuickForm($formName, $method, '', $target, $attributes);
        $this->MoodleQuickForm($formName, $method, '', $target, $attributes);
