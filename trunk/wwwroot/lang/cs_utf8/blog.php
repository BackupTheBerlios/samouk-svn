<?PHP // $Id: blog.php,v 1.5 2007/02/26 00:21:00 mudrd8mz Exp $ 
      // blog.php - created with Moodle 1.8 Beta (2007020400)


$string['addnewentry'] = 'Vložit nový příspěvek';
$string['addotags'] = 'Přidat globální klíčová slova';
$string['addptags'] = 'Přidat uživatelská klíčová slova';
$string['blockmenutitle'] = 'Nástroje blogu';
$string['blocktagstitle'] = 'Blog – klíčová slova';
$string['blocktitle'] = 'Nadpis pro blok s klíčovými slovy blogovacího systému';
$string['blog'] = 'Blog';
$string['blogdeleteconfirm'] = 'Smazat tento příspěvek?';
...
$string['noentriesyet'] = 'Nejsou k dispozici žádné zveřejněné příspěvky';
$string['noguestpost'] = 'Hosté nemohou psát do blogu!';
$string['norighttodeletetag'] = 'Nemáte oprávnění ke smazání klíčového slova $a';
$string['notallowedtoedit'] = 'Nemáte oprávnění upravovat tento příspěvek';
$string['numberofentries'] = 'Příspěvky: $a';
$string['numberoftags'] = 'Počet zobrazovaných klíčových slov';
$string['otags'] = 'Globální klíčová slova';
$string['pagesize'] = 'Počet příspěvků na stránku';
$string['personalblogs'] = 'Uživatelé smějí číst pouze svůj vlastní blog';
$string['ptags'] = 'Uživatelská klíčová slova';
...
$string['viewcourseentries'] = 'Číst blogy kurzu';
