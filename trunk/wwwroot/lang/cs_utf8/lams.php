<?PHP // $Id: lams.php,v 1.2 2007/04/07 13:18:29 mudrd8mz Exp $ 
      // lams.php - created with Moodle 1.8 + (2007021502)


$string['createSequence'] = 'Vytvořit novou sekvenci';
$string['editSequence'] = 'Editovat vybranou sekvenci';
...
$string['openauthor'] = 'Otevřít LAMS Author';
$string['openlearner'] = 'Otevřít LAMS Learner';
$string['openmonitor'] = 'Otevřít LAMS Monitor';
$string['refreshSequenceList'] = 'Aktualizovat seznam sekvencí';
$string['selectExistingSequence'] = 'Vybrat stávají sekvenci nebo vytvořit novou sekvenci';
$string['sequence'] = 'Vybrat sekvenci';
$string['serverid'] = 'Vložit ID serveru získané od <a href=http://www.lamsinternational.com target=_blank>LAMS international</a>.';
$string['serverkey'] = 'Vložit tajný klíč serveru získaný od <a href=http://www.lamsinternational.com target=_blank>LAMS international</a>.';
